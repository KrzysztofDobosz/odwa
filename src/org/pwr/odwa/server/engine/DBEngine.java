...
import org.pwr.odwa.server.MetaSQLApi;
...
public class DBEngine
{
	...
	MetaSQLApi sqlApi = new MetaSQLApi();
	...
	public void receiveMetadata(String str)
	{
	   ...
	   DBHash hash = sqlApi.getStructureHash(str);
	   sqlApi.refreshMetaData(struct);
	}
	...
	DBResult executeQuery(UserSelection Query)
	{
	   ...
	   sqlApi.translateMetaElement(new MetaElement());
		return null;
	}
